...
public class PlusBasicServlet extends HttpServlet {
   ...
   */
  private static final String API_KEY = "AIzaSyBiVLGeNIdOgv_9pU9oViNfBRPWflvG3nY";
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    Plus plus = new Plus.Builder(httpTransport, jsonFactory, null).setApplicationName("API Demo")
